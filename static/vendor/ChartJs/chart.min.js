...
function applyStack(e, i, a, s = {}) {
    ...
    if (null !== i) {
        ...
        for (o = 0, l = n.length; o < l; ++o) {
            ...
            d = e.values[h], isNumberFinite(d) && (r || 0 === i || sign(i) === sign(d)) && (i += d)
        }
        return t || s.all ? i : 0
    }
}
...
function convertObjectDataToArray(t, e) {
    var {
        iScale: e,
        vScale: i
    } = e, a = "x" === e.axis ? "x" : "y", s = "x" === i.axis ? "x" : "y", n = Object.keys(t);
    const r = new Array(n.length);
    let o, l, h;
    for (o = 0, l = n.length; o < l; ++o) h = n[o], r[o] = {
        [a]: h,
        [s]: t[h]
    };
    return r
...
class DatasetController {
    ...
    buildOrUpdateElements(t) {
        ...
        this._dataCheck();
        var s = e._stacked;
        e._stacked = isStacked(e.vScale, e), e.stack !== i.stack && (a = !0, clearStacks(e), e.stack = i.stack), this._resyncElements(t), !a && s === e._stacked || (updateStacks(this, e._parsed), e._stacked = isStacked(e.vScale, e))
    }
    configure() {
...
class BarController extends DatasetController {
    ...
    _getStacks(t, e) {
        ...
        var a = i.getMatchingVisibleMetas(this._type).filter(t => t.controller.options.grouped),
            s = i.options.stacked;
        const n = [];
        ...
        for (const l of a)
            if ((void 0 === e || !(t => {
                ...
                })(l)) && ((!1 === s || -1 === n.indexOf(l.stack) || void 0 === s && void 0 === l.stack) && n.push(l.stack), l.index === t)) break;
    ...
    _getAxis() {
        ...
        for (const i of this.chart.data.datasets) t[valueOrDefault("x" === this.chart.options.indexAxis ? i.xAxisID : i.yAxisID, e)] = !0;
    ...
    draw() {
        ...
        var a = i.length;
        let s = 0;
        for (; s < a; ++s) null === this.getParsed(s)[e.axis] || i[s].hidden || i[s].draw(this._ctx)
    }
}
...
function binarySearch(t, e, i, a) {
    var {
        ...
        data: n,
        _sorted: r
    } = t, o = s._cachedMeta.iScale, l = t.dataset && t.dataset.options ? t.dataset.options.spanGaps : null;
    if (o && e === o.axis && "r" !== e && r && n.length) {
        ...
        if (!a) {
            ...
            if (l) {
                const c = s._cachedMeta["vScale"],
                    u = t["_parsed"];
                r = u.slice(0, d.lo + 1).reverse().findIndex(t => !isNullOrUndef(t[c.axis])), o = (d.lo -= Math.max(0, r), u.slice(d.hi).findIndex(t => !isNullOrUndef(t[c.axis])));
                d.hi += Math.max(0, o)
            }
            return d
        }
        if (s._sharedOptions) {
            ...
            if (a) return l = h(n, e, i - a), t = h(n, e, i + a), {
                lo: l.lo,
                hi: t.hi
            }
        }
...
class Scale extends Element {
    ...
    _computeGridLineItems(t) {
        ...
        "top" === n ? (v = p(this.bottom), k = this.bottom - d, D = v - u, P = p(t.top) + u, C = t.bottom) : "bottom" === n ? (v = p(this.top), P = t.top, C = p(t.bottom) - u, k = v + u, D = this.top + d) : "left" === n ? (v = p(this.right), y = this.right - d, S = v - u, M = p(t.left) + u, A = t.right) : "right" === n ? (v = p(this.left), M = t.left, A = p(t.right) - u, y = v + u, S = this.left + d) : "x" === e ? ("center" === n ? v = p((t.top + t.bottom) / 2 + .5) : isObject(n) && (m = n[f = Object.keys(n)[0]], v = p(this.chart.scales[f].getPixelForValue(m))), P = t.top, C = t.bottom, k = v + u, D = k + d) : "y" === e && ("center" === n ? v = p((t.left + t.right) / 2) : isObject(n) && (m = n[f = Object.keys(n)[0]], v = p(this.chart.scales[f].getPixelForValue(m))), y = v - u, S = y - d, M = t.left, A = t.right);
        ...
        for (x = 0; x < h; x += w) {
            ...
            void 0 !== (b = getPixelForGridLine(this, x, o)) && (_ = _alignPixel(i, b, T), l ? y = S = M = A = _ : k = D = P = C = _, c.push({
                tx1: y,
                ty1: k,
                tx2: S,
                ty2: D,
    ...
    _computeLabelItems(t) {
        ...
        for (f = 0, m = o.length; f < m; ++f) {
            ...
            var C = s.setContext(this.getContext(f)),
                w = (y = this.getPixelForTick(f) + s.labelOffset, S = (k = this._resolveTickFontOptions(f)).lineHeight, (D = isArray(v) ? v.length : 1) / 2),
                O = C.color,
                L = C.textStrokeColor,
                T = C.textStrokeWidth;
            let t = _;
            r ? (x = y, "inner" === _ && (t = f === m - 1 ? this.options.reverse ? "left" : "right" : 0 === f ? this.options.reverse ? "right" : "left" : "center"), M = "top" === a ? "near" === h || 0 != g ? -D * S + S / 2 : "center" === h ? -A.highest.height / 2 - w * S + S : -A.highest.height + S / 2 : "near" === h || 0 != g ? S / 2 : "center" === h ? A.highest.height / 2 - w * S : A.highest.height - D * S, c && (M *= -1), 0 == g || C.showLabelBackdrop || (x += S / 2 * Math.sin(g))) : (b = y, M = (1 - D) * S / 2);
            let i;
...
class Chart {
    ...
    draw() {
        ...
        if (this._resizeBeforeDraw && ({
                width: e,
                height: i
            } = this._resizeBeforeDraw, this._resizeBeforeDraw = null, this._resize(e, i)), this.clear(), !(this.width <= 0 || this.height <= 0) && !1 !== this.notifyPlugins("beforeDraw", {
                cancelable: !0
            })) {
    ...
    _drawDataset(t) {
        ...
        !1 !== this.notifyPlugins("beforeDatasetDraw", i) && (a && clipArea(e, a), t.controller.draw(), a && unclipArea(e), i.cancelable = !1, this.notifyPlugins("afterDatasetDraw", i))
    }
    isPointInArea(t) {
...
function clipSelf(t, e, i) {
    var {
        ...
        borderWidth: o,
        borderJoinStyle: l
    } = o, h = Math.min(o / n, _normalizeAngle(e - i));
    t.beginPath(), t.arc(a, s, n - o / 2, e + h / 2, i - h / 2), 0 < r ? (h = Math.min(o / r, _normalizeAngle(e - i)), t.arc(a, s, r + o / 2, i - h / 2, e + h / 2, !0)) : (r = Math.min(o / 2, n * _normalizeAngle(e - i)), "round" === l ? t.arc(a, s, r, i - PI / 2, e + PI / 2, !0) : "bevel" === l && (o = -(h = 2 * r * r) * Math.cos(i + PI / 2) + a, n = -h * Math.sin(i + PI / 2) + s, l = h * Math.cos(e + PI / 2) + a, r = h * Math.sin(e + PI / 2) + s, t.lineTo(o, n), t.lineTo(l, r))), t.closePath(), t.moveTo(0, 0), t.rect(0, 0, t.canvas.width, t.canvas.height), t.clip("evenodd")
}
...
function drawBorder(e, i, a, s, n) {
    var {
        ...
        borderDashOffset: g,
        borderRadius: p
    } = h, f = "inner" === h.borderAlign;
    if (d) {
        e.setLineDash(u || []), e.lineDashOffset = g, f ? (e.lineWidth = 2 * d, e.lineJoin = c || "round") : (e.lineWidth = d, e.lineJoin = c || "bevel");
        let t = i.endAngle;
        if (r) {
            pathArc(e, i, a, s, t, n);
        ...
        f && clipArc(e, i, t), h.selfJoin && t - o >= PI && 0 === p && "miter" !== c && clipSelf(e, i, t), r || (pathArc(e, i, a, s, t, n), e.stroke())
    }
}
...
function containsDefaultColorsDefenitions() {
    return "rgba(0,0,0,0.1)" !== defaults.borderColor || "rgba(0,0,0,0.1)" !== defaults.backgroundColor
}
var plugin_colors = {
    id: "colors",
    defaults: {
    ...
    beforeLayout(t, e, i) {
        if (i.enabled) {
            ...
            var a = n["elements"],
                a = containsColorsDefinitions(s) || containsColorsDefinition(n) || a && containsColorsDefinitions(a) || containsDefaultColorsDefenitions();
...
function _drawfill(t, e, i) {
    ...
    a && r.points.length && (clipArea(t, i), doFill(t, {
        line: r,
        target: a,
        above: h,
        below: e,
...
function doFill(t, e) {
    ...
    t.save();
    let h = n;
    n !== s && ("x" === e ? (clipVertical(t, a, r.top), fill(t, {
        line: i,
        target: a,
        color: s,
        scale: o,
        property: e,
        clip: l
    }), t.restore(), t.save(), clipVertical(t, a, r.bottom)) : "y" === e && (clipHorizontal(t, a, r.left), fill(t, {
        line: i,
        target: a,
        color: n,
        scale: o,
        property: e,
        clip: l
    }), t.restore(), t.save(), clipHorizontal(t, a, r.right), h = s)), fill(t, {
        line: i,
        target: a,
        color: h,
        scale: o,
...
function clipHorizontal(t, e, i) {
    ...
    for (const d of a) {
        ...
        n ? (t.moveTo(h.x, h.y), n = !1) : (t.lineTo(i, h.y), t.lineTo(h.x, h.y)), (r = !!e.pathSegment(t, d, {
            move: r
        })) ? t.closePath() : t.lineTo(i, o.y)
    }
...
function fill(e, t) {
    ...
    for ({
        ...
        } = l, g = !0 !== a, u = (e.save(), e.fillStyle = u, clipBounds(e, r, o, g && _getBounds(s, d, c)), e.beginPath(), !!i.pathSegment(e, l));
        let t;
        g && (u ? e.closePath() : interpolatedLineTo(e, a, c, s), g = !!a.pathSegment(e, h, {
            move: u,
            reverse: !0
        }), (t = u && g) || interpolatedLineTo(e, a, d, s)), e.closePath(), e.fill(t ? "evenodd" : "nonzero"), e.restore()
    }
}
...
function clipBounds(s, n, r, o) {
    ...
    if ("x" === o || "y" === o) {
        let t, e, i, a;
        a = "x" === o ? (t = l, e = n.top, i = h, n.bottom) : (t = n.left, e = l, i = n.right, h), s.beginPath(), r && (t = Math.max(t, r.left), i = Math.min(i, r.right), e = Math.max(e, r.top), a = Math.min(a, r.bottom)), s.rect(t, e, i - t, a - e), s.clip()
    }
}
...
class Legend extends Element {
    ...
    _draw() {
        ...
        const {
            ...
            boxHeight: P,
            itemHeight: A
        } = getBoxSize(v, k), C = this.isHorizontal(), w = this._computeTitleHeight(), O = (D = C ? {
        ...
        this.legendItems.forEach((t, e) => {
            ...
            let s = D.x,
                n = D.y;
            b.setWidth(this.width), C ? 0 < e && s + i + y > this.right && (n = D.y += O, D.line++, s = D.x = _alignStartEnd(m, this.left + y, this.right - p[D.line])) : 0 < e && n + O > this.bottom && (s = D.x = s + g[D.line].width + y, D.line++, n = D.y = _alignStartEnd(m, this.top + w + y, this.bottom - g[D.line].height));
            ...
            e = e, h = n, d = t, isNaN(M) || M <= 0 || isNaN(P) || P < 0 || (f.save(), r = valueOrDefault(d.lineWidth, 1), f.fillStyle = valueOrDefault(d.fillStyle, x), f.lineCap = valueOrDefault(d.lineCap, "butt"), f.lineDashOffset = valueOrDefault(d.lineDashOffset, 0), f.lineJoin = valueOrDefault(d.lineJoin, "miter"), f.lineWidth = r, f.strokeStyle = valueOrDefault(d.strokeStyle, x), f.setLineDash(valueOrDefault(d.lineDash, [])), v.usePointStyle ? (o = {
                ...
                h: P,
                radius: c
            }) : f.rect(l, o, M, P), f.fill(), 0 !== r && f.stroke()), f.restore()), s = _textX(a, s + M + S, C ? s + i : this.right, u.rtl), h = b.x(s), e = n, d = t, renderText(f, d.text, h, e + A / 2, _, {
                strikethrough: d.hidden,
                textAlign: b.textAlign(d.textAlign)
            }), C ? D.x += i + y : "string" != typeof t.text ? (c = _.lineHeight, D.y += calculateLegendItemHeight(t, c) + y) : D.y += O
...
const positioners = {
    average(t) {
        ...
        for (e = 0, i = t.length; e < i; ++e) {
            const o = t[e].element;
            var r;
            o && o.hasValue() && (r = o.tooltipPosition(), a.add(r.x), s += r.y, ++n)
        }
        return 0 !== n && 0 !== a.size && {
            x: [...a].reduce((t, e) => t + e) / a.size,
            y: s / n
        }
    },
    nearest(t, e) {
...
class RadialLinearScale extends LinearScaleBase {
    ...
    drawGrid() {
        ...
        if (e.pointLabels.display && drawPointLabels(this, n), a.display && this.ticks.forEach((t, e) => {
                (0 !== e || 0 === e && this.min < 0) && (o = this.getDistanceFromCenterForValue(t.value), t = this.getContext(e), e = a.setContext(t), t = s.setContext(t), drawRadiusLine(this, e, o, n, t))
            }), i.display) {
            for (t.save(), r = n - 1; 0 <= r; r--) {
                ...
                c && d && (t.lineWidth = c, t.strokeStyle = d, t.setLineDash(h.borderDash), t.lineDashOffset = h.borderDashOffset, o = this.getDistanceFromCenterForValue(e.reverse ? this.min : this.max), l = this.getPointPosition(r, o), t.beginPath(), t.moveTo(this.xCenter, this.yCenter), t.lineTo(l.x, l.y), t.stroke())
            }
            t.restore()
        }
    }
    ...
    drawLabels() {
        ...
        if (l.display) {
            ...
            r.save(), r.translate(this.xCenter, this.yCenter), r.rotate(t), r.textAlign = "center", r.textBaseline = "middle", this.ticks.forEach((t, e) => {
                var i, a;
                0 === e && 0 <= this.min && !o.reverse || (i = l.setContext(this.getContext(e)), a = toFont(i.font), s = this.getDistanceFromCenterForValue(this.ticks[e].value), i.showLabelBackdrop && (r.font = a.string, n = r.measureText(t.label).width, r.fillStyle = i.backdropColor, e = toPadding(i.backdropPadding), r.fillRect(-n / 2 - e.left, -s - a.size / 2 - e.top, n + e.width, a.size + e.height)), renderText(r, t.label, 0, -s, a, {
                    color: i.color,
