...
class OsintEjecucion:
    ...
    def crear(proyecto_id, servicio_osint_id, usuario_id):
        """Crea o actualiza ejecución OSINT"""
        try:
            ...
            cursor.execute("""
                SELECT id FROM osint_ejecuciones
                WHERE proyecto_id=%s AND servicio_osint_id=%s
            ...
            conn.commit()
            print(f"[OsintEjecucion] Ejecución: ID={ejecucion_id}, servicio={servicio_osint_id}, proyecto={proyecto_id}")
            return ejecucion_id
    ...
    def get_handlers_map():
        ...
        nombre_a_handler = {
            ...
            'Deteccion IA Tools' : 'deteccion_ia_tools'
        }
