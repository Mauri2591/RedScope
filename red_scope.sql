...
(9, 'Prueba 3', '111222222', '123123123', '2026-07-16 15:47:15', '2026-07-16 15:47:15', 1);
...
CREATE TABLE `findings` (
  ...
  `referencias_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `detectado` datetime DEFAULT current_timestamp(),
  `herramienta` varchar(50) DEFAULT NULL,
  `actualizacion` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `estado_mitigacion` int(11) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `findings_evidence`
--

INSERT INTO `findings_evidence` (`id`, `finding_id`, `file_path`, `creacion`, `estado_id`) VALUES
(7, 1, 'uploads/findings/8a1d6fa0-f08f-4889-b8cc-e08964ec5190.png', '2026-08-03 12:21:10', 2),
(8, 1, 'uploads/findings/f5fe7711-f384-45bc-822f-da3a60003d0e.png', '2026-08-03 12:21:10', 2),
(9, 1463, 'uploads/findings/85256b63-e5c7-416f-9f4f-3a6ac4cf7e40.png', '2026-08-03 18:17:14', 2),
(10, 1481, 'uploads/findings/78afa3a8-010e-436d-9208-919fdeb516e1.png', '2026-08-03 18:19:32', 2),
(11, 1481, 'uploads/findings/7318d617-d348-4323-8928-90ad31e19d2b.png', '2026-08-03 18:19:32', 2),
(12, 1463, 'uploads/findings/37366a6e-e5d6-40b7-a163-cc828313f1d4.png', '2026-08-03 18:21:06', 1),
(13, 1481, 'uploads/findings/e2eac0ea-0c31-4e58-baa0-dc91268acbcb.png', '2026-08-03 18:21:50', 1),
(14, 1482, 'uploads/findings/9e5af04d-faa2-43a0-84ab-9c806a66ad54.png', '2026-08-03 18:22:47', 1),
(15, 1565, 'uploads/findings/eef8f7fc-044b-4ff1-ba58-cf61bb532572.png', '2026-08-03 18:23:57', 1),
(16, 1690, 'uploads/findings/3914c964-80c7-4934-8840-f6a420125ebe.png', '2026-08-03 18:30:32', 1),
(17, 1690, 'uploads/findings/8ccccb54-76bc-45e7-b95d-92330d35ff8d.png', '2026-08-03 18:30:32', 1),
(18, 1690, 'uploads/findings/ff82a525-cc5d-4208-b165-a3628f86b557.png', '2026-08-03 18:32:56', 1),
(19, 1932, 'uploads/findings/15166e35-01de-4424-aa45-07c70f126d38.png', '2026-08-03 18:40:07', 1),
(20, 1932, 'uploads/findings/837fc53e-e271-42df-a3e5-8b6367918aa1.png', '2026-08-03 18:40:07', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `osint_config_tipos`
--

CREATE TABLE `osint_config_tipos` (
  `id` int(11) NOT NULL,
  `nombre` varchar(50) NOT NULL,
...
--
-- Volcado de datos para la tabla `osint_config_tipos`
--

INSERT INTO `osint_config_tipos` (`id`, `nombre`, `descripcion`, `placeholder`, `activo`) VALUES
(1, 'DOMINIO', 'Dominio principal', 'example.com', 1),
(2, 'SUBDOMINIO', 'Subdomios y wildcard', '*.example.com, api.example.com', 1),
(3, 'SERVICIOS', 'Servicios específicos', 'mail.example.com, smtp.example.com', 1),
(4, 'IPS', 'Rangos de IP privados', '192.168.0.0/16, 10.0.0.0/8', 1),
(5, 'CLOUD', 'Servicios en la nube', '*.amazonaws.com, *.azurewebsites.net', 1),
(6, 'REPOSITORIOS', 'Repositorios públicos', 'github.com/example, gitlab.com/example', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `osint_ejecuciones`
--

CREATE TABLE `osint_ejecuciones` (
  `id` int(11) NOT NULL,
  `proyecto_id` int(11) NOT NULL,
  `servicio_osint_id` int(11) DEFAULT NULL,
  `usuario_id` int(11) NOT NULL,
  `estado` varchar(50) DEFAULT 'QUEUED',
  `resultado` longtext DEFAULT NULL,
  `error` text DEFAULT NULL,
...
INSERT INTO `proyectos` (`id`, `titulo`, `cliente_id`, `sector_id`, `usuario_creador_id`, `tipo_proyecto_id`, `tipo_servicio_id`, `autenticado`, `creacion`, `actualizacion`, `estado_id`) VALUES
(42, 'Proyecto de Prueba', 1, 1, 1, 3, 1, NULL, '2026-08-03 10:17:46', '2026-08-03 10:17:46', 1),
(43, 'Prueba', 1, 1, 1, 4, 6, NULL, '2026-08-03 11:25:36', '2026-08-03 11:25:36', 1);
...
(15, 42, 'AKIAYX67PJ3VDX5T4GKM', 'gAAAAABqcJZvWlm-gA9uceiwbcLl1PlFVAmHfbKEj8LLJ2eNYO3sCSgV0kY6TQd0-VoDHF2UNJzICJg4dP_ZQ857a7RAJRANx8vGsE138dW7v7YWvZXp-BTM1pX9vSAcclmc-OmQeU37', '601227218666', '2026-08-03 10:23:59', 'us-east-1', 1, 'role', 'arn:aws:iam::601227218666:role/RedScope-PentestRole', 'redscope-lab-2024');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `proyecto_osint_config`
--

CREATE TABLE `proyecto_osint_config` (
  `id` int(11) NOT NULL,
  `proyecto_id` int(11) NOT NULL,
  `config_tipo_id` int(11) NOT NULL,
  `valor` text NOT NULL,
  `creacion` datetime DEFAULT current_timestamp(),
  `estado_id` int(11) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `reporte_contenido_secciones` (
  ...
  `objetivos` varchar(1500) DEFAULT NULL,
...
(11, 'anexo_metodologia', 'Anexo 1:  Frameworks y Metodología', 'anexo', 'aws', 43, 68, 0, 1),
...
--
-- Estructura de tabla para la tabla `servicios_osint`
--

CREATE TABLE `servicios_osint` (
  `id` int(11) NOT NULL,
  `nombre` varchar(100) NOT NULL,
  `descripcion` varchar(2500) DEFAULT NULL,
  `tipos_servicio_id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `servicios_osint`
--

INSERT INTO `servicios_osint` (`id`, `nombre`, `descripcion`, `tipos_servicio_id`, `creacion`, `actualizacion`, `estado_id`) VALUES
(1, 'Discovery Subdominio', 'Descubrimiento de subdominios y wildcards', 3, '2026-07-27 20:59:59', NULL, 1),
(2, 'Enumeración de Servicios', 'Identificación de servicios activos en el dominio', 3, '2026-07-27 20:59:59', NULL, 1),
(3, 'Mapeo de IPs', 'Análisis de rangos IP privados y públicos', 3, '2026-07-27 20:59:59', NULL, 1),
(4, 'Recon Cloud', 'Auditoría de servicios en la nube (AWS, Azure, GCP)', 3, '2026-07-27 20:59:59', NULL, 1),
(5, 'Escaneo de Repositorios', 'Búsqueda de credenciales y datos sensibles en repos públicos', 3, '2026-07-27 20:59:59', NULL, 1),
(6, 'Análisis de DNS', 'Resolución DNS y registros de dominio', 3, '2026-07-27 20:59:59', NULL, 1),
(7, 'Búsqueda de Endpoints', 'Descubrimiento de APIs y endpoints expuestos', 3, '2026-07-27 20:59:59', NULL, 1),
(8, 'Google Dorking', 'Búsquedas avanzadas de información pública', 3, '2026-07-27 20:59:59', NULL, 1);
...
(5, 3, 'HUAWEI', '2026-02-15 11:45:58', NULL, 2),
(6, 4, 'EXTERNAL SURFACE ATTACK MANAGMENT', '2026-02-15 11:45:58', NULL, 1);
...
--
-- Indices de la tabla `osint_config_tipos`
--
ALTER TABLE `osint_config_tipos`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nombre` (`nombre`);

--
-- Indices de la tabla `osint_ejecuciones`
--
ALTER TABLE `osint_ejecuciones`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_osint_execution` (`proyecto_id`,`servicio_osint_id`),
...
--
-- Indices de la tabla `proyecto_osint_config`
--
ALTER TABLE `proyecto_osint_config`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_proyecto_tipo` (`proyecto_id`,`config_tipo_id`),
  ADD KEY `config_tipo_id` (`config_tipo_id`);
...
--
-- Indices de la tabla `servicios_osint`
--
ALTER TABLE `servicios_osint`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tipos_servicio_id` (`tipos_servicio_id`),
  ADD KEY `estado_id` (`estado_id`);
...
--
-- AUTO_INCREMENT de la tabla `osint_config_tipos`
--
ALTER TABLE `osint_config_tipos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `osint_ejecuciones`
--
ALTER TABLE `osint_ejecuciones`
...
--
-- AUTO_INCREMENT de la tabla `proyecto_osint_config`
--
ALTER TABLE `proyecto_osint_config`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `servicios_osint`
--
ALTER TABLE `servicios_osint`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- Filtros para la tabla `osint_ejecuciones`
--
ALTER TABLE `osint_ejecuciones`
  ADD CONSTRAINT `osint_ejecuciones_ibfk_1` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `osint_ejecuciones_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `osint_ejecuciones_ibfk_3` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`id`);
...
--
-- Filtros para la tabla `proyecto_osint_config`
--
ALTER TABLE `proyecto_osint_config`
  ADD CONSTRAINT `proyecto_osint_config_ibfk_1` FOREIGN KEY (`proyecto_id`) REFERENCES `proyectos` (`id`),
  ADD CONSTRAINT `proyecto_osint_config_ibfk_2` FOREIGN KEY (`config_tipo_id`) REFERENCES `osint_config_tipos` (`id`);
...
--
-- Filtros para la tabla `servicios_osint`
--
ALTER TABLE `servicios_osint`
  ADD CONSTRAINT `servicios_osint_ibfk_1` FOREIGN KEY (`tipos_servicio_id`) REFERENCES `tipos_servicio` (`id`),
  ADD CONSTRAINT `servicios_osint_ibfk_2` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`id`);
